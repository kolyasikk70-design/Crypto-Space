...
5. 🐋 СПЕЦИАЛЬНЫЕ ПРАВИЛА ДЛЯ ОНЧЕЙН И КИТОВ (#Ончейн / Whale Alert):
   Если новость или твит касается перевода/накопления токенов или движения китов:
   — ОБЯЗАТЕЛЬНО укажи адрес/кошелек (например: кит `0xc985...` или неизвестный адрес).
   — ОБЯЗАТЕЛЬНО опиши вектор движения: ОТКУДА и КУДА пошли токены (например: с Binance на холодный кошелек).
   — ОБЯЗАТЕЛЬНО детально разбери направление: «С БИРЖИ НА КОШЕЛЕК» (накопление/бычий знак) ИЛИ «С КОШЕЛЬКА НА БИРЖУ» (подготовка к продаже/давление на цену).
...
4. 0% ВОДЫ. Только сухая суть и конкретика.{onchain_directive}
"""
