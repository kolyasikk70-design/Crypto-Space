...
2. УМЕСТНЫЕ ЭМОДЗИ (СТРОГО 2-3 НА ВЕСЬ ПОСТ):
   — Используй 2-3 аккуратных и тематических эмодзи как визуальные акценты (например, 🚀, 💡, 🧠, 📊, ⚡). Без перебора и пестроты!
...
2. Ровно 2-3 аккуратных и уместных эмодзи на весь пост (например: 🚀, 💡, 🧠, 📊). Никакого перебора!
